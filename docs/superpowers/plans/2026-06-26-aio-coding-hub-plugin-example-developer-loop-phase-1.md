  ...
  return {
    ...
    "README.md": exampleReadme(
      ...
      [
        ...
        "pnpm --filter create-aio-plugin cli replay --explain . fixtures/claude-request.json gateway.request.afterBodyRead",
        "pnpm --filter create-aio-plugin cli replay --explain . fixtures/codex-request.json gateway.request.afterBodyRead",
...
function redactorExampleTemplate(id: string, name: string): ScaffoldFiles {
  ...
  return {
    ...
    "README.md": exampleReadme(
      ...
      [
        "pnpm --filter create-aio-plugin cli validate --strict .",
        "pnpm --filter create-aio-plugin cli replay --explain . fixtures/request-hit.json gateway.request.beforeSend",
        "pnpm --filter create-aio-plugin cli replay --explain . fixtures/request-miss.json gateway.request.beforeSend",
        "pnpm --filter create-aio-plugin cli replay --explain . fixtures/log-redact.json log.beforePersist",
        "pnpm --filter create-aio-plugin cli pack .",
        "pnpm --filter create-aio-plugin cli publish-check .",
      ]
    ),
...
function responseGuardExampleTemplate(id: string, name: string): ScaffoldFiles {
  ...
  return {
    ...
    "README.md": exampleReadme(
      ...
      [
        "pnpm --filter create-aio-plugin cli validate --strict .",
        "pnpm --filter create-aio-plugin cli replay --explain . fixtures/response-warn.json gateway.response.after",
        "pnpm --filter create-aio-plugin cli replay --explain . fixtures/response-pass.json gateway.response.after",
        "pnpm --filter create-aio-plugin cli pack .",
        "pnpm --filter create-aio-plugin cli publish-check .",
      ]
    ),
...
```bash
pnpm --filter create-aio-plugin cli replay --explain ./acme.prompt-helper ./acme.prompt-helper/fixtures/claude-request.json gateway.request.afterBodyRead
pnpm --filter create-aio-plugin cli replay --explain ./acme.prompt-helper ./acme.prompt-helper/fixtures/codex-request.json gateway.request.afterBodyRead
```
````
